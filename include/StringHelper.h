...
/*! \fn static std::string StringHelper::unquote(std::string str);
 * Removes leading and tailing whitespaces
 * \param str Input
 *  \return std::string Unquoted string
 */

/*! \fn static std::string StringHelper::extractName(std::string str);
...
/*! \fn static std::string StringHelper::extractClassification(std::string str);
 * Expects a string of the form: "nodename [nodelabel]", where nodename and nodelabel can be arbitrary strings.
 * \param str Input
 *  \return std::string Will return the nodelabel-part of the string
 */

/*! \fn static std::string StringHelper::extractClass(std::string classification)
...
/*! \fn static std::map<std::string, int> StringHelper::extractDistribution(std::string classification)
 * Expects a class label of the form: "class {c1:v1,c2:v2,...,cn:vn}",  where "class" is some classification cathegory and c_i/v_i represent a distribution over the possibilities.
 * \param str Input
...
/*! \fn static std::string StringHelper::extractValue(std::string str)
 * Expects a value-value pair of kind "key:value"
 * \param str Input
 *  \return std::string The value part of the string
 */

/*! \fn static std::string StringHelper::toString(int v)
 * Converts an integer value into a string
 * \param v Input
 *  \return std::string The input as string
 */

/*! \fn static std::string StringHelper::toString(douvle v)
 * Converts an double value into a string
 * \param v Input
 *  \return std::string The input as string
 */

/*! \fn static int StringHelper::atoi(std::string str)
...
/*! \fn static double StringHelper::atof(std::string str)
