...
namespace dlvhex{
	namespace dd{
		namespace util{
			/**
			 * \brief This class provides the data structures and methodes necessary to build decision diagrams from answer sets representing them.
			 */
			class DecisionDiagram{
			public:
				/**
				 * \brief General exception class for errors in the context of decision diagrams.
				 */
				...
				/**
				 * \brief A class representing one node of a decision diagram.
				 */
				class LeafNode;
				class Node{
				private:
				...
				/*! \fn std::string DecisionDiagram::Node::getLabel() const
				...
				/*! \fn Edge* DecisionDiagram::Node::getOutEdge(int index)
				...
				/*! \fn std::string DecisionDiagram::Node::toString() const
				...
				/**
				 * \brief A class representing one leaf node of a decision diagram.
				 */
				...
				/*! \fn std::string DecisionDiagram::LeafNode::toString() const
				...
				/**
				 * \brief A class representing the condition of an edge of a decision diagram.
				 */
				class Condition{
				public:
					/**
				...
				/*! \fn std::string DecisionDiagram::Condition::toString() const
				 *  \brief Returns a string representation of this condition.
				...
				/**
				 * \brief A class representing one edge of a decision diagram.
				 */
				class ElseEdge;
				class Edge{
				private:
				...
				/*! \fn std::string DecisionDiagram::Edge::toString() const
				...
				/**
				 * \brief A class representing one unconditional (else) edge of a decision diagram.
				 */
				...
				/*! \fn std::string DecisionDiagram::ElseEdge::toString() const
...
/*! \fn dlvhex::dd::util::DecisionDiagram::DecisionDiagram()
 *  \brief Creates an empty decision diagram.
 */

/*! \fn dlvhex::dd::util::DecisionDiagram::DecisionDiagram(const DecisionDiagram &dd2)
 *  \brief Copy-constructor
 *  \param dd2 Template decision diagram
 */

/*! \fn dlvhex::dd::util::DecisionDiagram::DecisionDiagram(AtomSet as)
...
/*! \fn void dlvhex::dd::util::DecisionDiagram::clear()
 * Removes all nodes and edges from this decision diagram.
 */

/*! \fn DecisionDiagram& dlvhex::dd::util::DecisionDiagram::operator=(const DecisionDiagram &dd2)
...
/*! \fn Node* dlvhex::dd::util::DecisionDiagram::addNode(std::string label)
...
/*! \fn LeafNode* dlvhex::dd::util::DecisionDiagram::addLeafNode(std::string label, std::string classification)
...
/*! \fn Node* dlvhex::dd::util::DecisionDiagram::addNode(Node* template_)
...
/*! \fn void dlvhex::dd::util::DecisionDiagram::removeNode(Node* n)
...
/*! \fn void dlvhex::dd::util::DecisionDiagram::removeNode(Node* n, bool forceRemoveEdges)
 * Removes a node from this decision diagram.
 *  \param n A pointer to the node to remove (must be a pointer to exactly the node to remove, not only to one with the same attributes!)
...
/*! \fn Edge* dlvhex::dd::util::DecisionDiagram::addEdge(Node* from, Node* to, Condition c)
...
/*! \fn Edge* dlvhex::dd::util::DecisionDiagram::addEdge(std::string from, std::string to, Condition c)
...
/*! \fn Edge* dlvhex::dd::util::DecisionDiagram::addElseEdge(Node* from, Node* to)
...
/*! \fn Edge* dlvhex::dd::util::DecisionDiagram::addElseEdge(std::string from, std::string to)
 * Adds a directed unconditional (else) edge between two nodes of this decision diagram.
 *  \param from The label of the node acting as the edge's source.
 *  \param to The label of the node acting as the edge's destination.
 *  \return Edge* A pointer to the added edge
...
/*! \fn Edge* dlvhex::dd::util::DecisionDiagram::addEdge(Edge* template_)
...
/*! \fn void dlvhex::dd::util::DecisionDiagram::removeEdge(Edge* e)
...
/*! \fn Node* dlvhex::dd::util::DecisionDiagram::addDecisionDiagram(DecisionDiagram* dd2)
...
/*! \fn Node* dlvhex::dd::util::DecisionDiagram::partialAddDecisionDiagram(DecisionDiagram *dd2, Node *n)
...
/*! \fn void dlvhex::dd::util::DecisionDiagram::setRoot(Node* root)
...
/*! \fn void dlvhex::dd::util::DecisionDiagram::useUniqueLabels(DecisionDiagram* dd2)
...
/*! \fn std::string dlvhex::dd::util::DecisionDiagram::getUniqueLabel(std::string proposal) const
...
/*! \fn std::set<Node*> dlvhex::dd::util::DecisionDiagram::getNodes() const
...
/*! \fn std::set<LeafNode*> dlvhex::dd::util::DecisionDiagram::getLeafNodes() const
...
/*! \fn std::set<Edge*> dlvhex::dd::util::DecisionDiagram::getEdges() const
...
/*! \fn Node* dlvhex::dd::util::DecisionDiagram::getRoot() const
...
/*! \fn Node* dlvhex::dd::util::DecisionDiagram::getNodeByLabel(std::string label) const
...
/*! \fn bool dlvhex::dd::util::DecisionDiagram::isTree() const
 * Checks if this decision diagram is a tree.
 *  \throws bool True iff this decision diagram is a tree, otherwise false.
 */

/*! \fn virtual bool dlvhex::dd::util::DecisionDiagram::operator==(const DecisionDiagram& dd2) const
...
/*! \fn bool dlvhex::dd::util::DecisionDiagram::containsPath(const Node* from, const Node* to) const;
...
/*! \fn std::string dlvhex::dd::util::DecisionDiagram::toString() const
